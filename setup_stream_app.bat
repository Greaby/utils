...
start "obs" /D "C:\Program Files\OBS" "OBS.exe"
...
"C:\Program Files\Mozilla Firefox\firefox.exe" -url "https://tweetdeck.twitter.com/" "https://www.youtube.com/live_dashboard" "https://www.twitch.tv/greaby/dashboard/live"
